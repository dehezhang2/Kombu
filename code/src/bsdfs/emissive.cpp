...
public:
    Emissive(const PropertyList &propList) : m_albedo(nullptr) {
        ...
        m_radiance = propList.getColor("radiance", Color3f(25.3, 2.1, 0.752));
    }
    virtual ~Emissive() {
        delete m_albedo;
    }
    ...
    virtual Color3f sample(BSDFQueryRecord &bRec, const Point2f &sample) const override {
        ...
        bRec.isEmissive = true;
        bRec.radiance = m_radiance;
...
NORI_REGISTER_CLASS(Emissive, "emissive");
NORI_NAMESPACE_END
